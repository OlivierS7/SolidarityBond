...
function oft_cookieConsent() {
    $("body").append('<div id="oft_cookieConsent" style="position:fixed;bottom:0;right:0;width:100%;background-color:#343A40;padding:20px;color:#e0e0e0;">' +
        ...
        '<a class="text-warning" href="/templates/mentionsLegales/cgu.html.twig">Plus d\'information</a></div>' +
        '<div class="text-center"><button id="oft_cookieConsent_valid" class="btn btn-warning" style="width:125px;margin-top: 20px;">Got it!</button></div>');
    oft_checkCookie();
