 ...
 */
final class Version20200617103842 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE first_name first_name VARCHAR(32) NOT NULL, CHANGE last_name last_name VARCHAR(64) NOT NULL, CHANGE email email VARCHAR(128) NOT NULL, CHANGE password password VARCHAR(64) NOT NULL, CHANGE address address VARCHAR(128) DEFAULT NULL, CHANGE phone phone VARCHAR(10) DEFAULT NULL');
    }
